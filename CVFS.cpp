...
#define REGULAR 1    //.c , .cpp  , .txt
#define SPECIAL 2    // symbolic files, driver files
...
void man(char *name)
{
    ...
    else if(strcmp(name,"write")==0)
    {
        ...
        printf("Usage: write File_name\nAfter this enter the data we wnat to write\n"); 
    }
    ...
    {
        printf("Description:Used to open existimg file\n");
    ...
    {
        printf("ERROR: no mutual entry available");
    }
}
/////////////////////////////////////////////////////////////////////////////////////////////
...
void DisplayHelp()
{
    ...
    printf("fstat: To dislpay information of file using file descriptor\n");
...
int main()
{
    ...
    while(1)
    {
        fflush(stdin);    //fala pusun gheto shiksak
        strcpy(str,"");   //string rikami houn jate
        ...
        else if(count==2)
        {
            ...
            else if(strcmp(command[0],"fstat")==0)
            {
                ...
                if(ret==-1)
                    printf("ERROR: Incorrect parameters\n");
                if(ret==-2)
                    printf("ERROE: There is no such a file\n");
                continue;
            }
        ...
        else if(count==3)
        {
            ...
            else if(strcmp(command[0],"open")==0)
            {
                ...
                if(ret==-1)
                    printf("ERROR: Incorerct parameters\n");
                if(ret==-2)
